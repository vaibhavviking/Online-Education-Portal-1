...
insert into Professor values(empid, name, post, dob, gender, deptid, email);
...
delimiter ;
/*Execute*/
call Insert_Professor(99,'uttam','Professor','2020-10-10','M',2,'XW@iiti.ac.in','P3','a5c1f56f8b914e6da0f86af7b0612186',@did,@rif,@inv); /*Emp ID, Name, DOB, Gender, Post, Dept ID, Email, User ID, Password*/
